...
//            MediaScannerConnection.scanFile(Global.getApplicationContext(),
...
//            Global.getApplicationContext().sendBroadcast(new Intent(Intent.ACTION_MEDIA_MOUNTED, Uri.parse("file://" +
...
//        final InputStream is = Global.getApplicationContext().getResources().openRawResource(id);
...
//        final Typeface typeface = Typeface.createFromAsset(Global.getApplicationContext().getAssets(), path);
...
//        final AssetManager assetManager = Global.getApplicationContext().getAssets();
//        try {
...
//    }
    ...
    /**
     * 根据文件路径获取文件
     *    // 地址https://github.com/Blankj/AndroidUtilCode
